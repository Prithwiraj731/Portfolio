...
export const DIGITAL_PRESENCE = {
  ...
  subtitle: 'Find me across the places where I build, share, and connect.',
  profiles: [
    {
      id: 'linkedin',
      platform: 'LinkedIn',
      ...
      handle: '@prithwiraj-mazumdar',
      description: 'Full-Stack Engineer · AI/LLM · Security',
      url: 'https://www.linkedin.com/in/prithwiraj-mazumdar-963086291/',
      cta: 'View Profile',
      contextLabel: 'PROFESSIONAL GRAPH',
      accent: '#0a66c2',
    ...
    },
    {
      ...
      tag: 'GITHUB // CODEBASE',
      name: 'Prithwiraj Mazumdar',
      handle: '@Prithwiraj731',
      description: 'Open Source · Systems · AI',
      url: 'https://github.com/Prithwiraj731',
      cta: 'Explore Code',
      contextLabel: 'SOURCE REPOSITORIES',
      accent: '#f0f6fc',
      glowColor: 'rgba(240, 246, 252, 0.12)',
    ...
    },
    {
      ...
      name: 'Prithwiraj Mazumdar',
      handle: '@prithwi731',
      description: 'Thoughts · Technology · Building',
      url: 'https://x.com/prithwi731',
      cta: 'Follow',
      contextLabel: 'PUBLIC DISCOURSE',
      accent: '#ffffff',
    ...
    },
    {
      ...
      handle: 'prithwi1016@gmail.com',
      description: 'Open for interesting projects, collaborations and ideas.',
      url: 'mailto:prithwi1016@gmail.com',
      cta: 'Send Email',
      contextLabel: 'DIRECT DISPATCH',
      accent: '#00ff84',
      glowColor: 'rgba(0, 255, 132, 0.12)',
